...
export function login(username, password, dispatch) {
  ...
  if (username === 'test@estee.com' && password === 'test123') {
    ...
    notification.open({
      ...
      description: 'Welcome to the DTIG Data Dashboard!',
    })
    return true
  }

  if (username === 'info@ta3woon.com' && password === 'test123') {
    window.localStorage.setItem('app.Authorization', '')
